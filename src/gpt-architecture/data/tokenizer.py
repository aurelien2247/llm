"""Tokenizers simples pour le prétraitement du texte."""
...
class SimpleTokenizerV1:
    ...
    def __init__(self, vocab: Dict[str, int]):
        """Initialiser le tokenizer avec un vocabulaire.
        
        Args:
            vocab: Dictionnaire mapping des jetons (string) à leurs indices (int).
        """
...
class SimpleTokenizerV2(SimpleTokenizerV1):
    ...
    def __init__(self, vocab: Dict[str, int], unk_token: str = "<|unk|>"):
        """Initialiser le tokenizer avec support pour les tokens inconnus.
        
        Args:
            vocab: Dictionnaire mapping des jetons à leurs indices.
            unk_token: Token utilisé pour les mots inconnus.
        """
